...
MVP cu autentificare Supabase, conversații private și trimitere de imagini de maximum 10 MB, vizibile numai membrilor. Include delogare manuală și automată după 15 minute de inactivitate.

1. Rulează integral `supabase-private-chat.sql`, apoi scriptul `supabase-chat-images.sql` în Supabase SQL Editor.
